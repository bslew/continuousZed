...
class zedParser(configparser.ConfigParser):
    def __init__(self):
        super().__init__()
#         list_keys=['db_keys']
...
def readConfigFile(inifile='continuousZed.ini', verbosity=0):
#     config = configparser.ConfigParser()
    homeLoc=os.environ['HOME']+os.sep+'.'
    homeLoc2=os.environ['HOME']+os.sep+'.config/continuousZed/'
    searchLocations=['./','etc/',homeLoc,homeLoc2,'/etc/continuousZed/']
